...
int imageManager::getImagesCount() { return imageCount; }

std::vector<image> imageManager::getImages() { return images; }
...
std::vector<image>
imageManager::getFilesInDirectory(std::string& directoryPath) {
